...
@section('container')
    ...
    <div class="col-lg-8">
        <form action="/dashboard/cars/{{ $car->id }}" method="POST" class="mb-5" enctype="multipart/form-data">
            @method('put')
            @csrf
            <div class="row mb-3">
                ...
                <div class="col-sm-8">
                    <select class="form-select" name="merk_id">
                        @foreach ($merks as $merk)
                            @if (old('merk_id', $car->merk->id) == $merk->id)
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-8">
                    ...
                    <div class="form-check form-check-inline">
                        @if (old('transmisi', $car->transmisi) === 'Automatic Transmision (AT)')
                    ...
                    <div class="form-check form-check-inline">
                        @if (old('transmisi', $car->transmisi) === 'Continuous Variable Transmision (CVT)')
                    ...
                    <div class="form-check form-check-inline">
                        @if (old('transmisi', $car->transmisi) === 'Dual Clutch Transmision (DCT)')
                    ...
                    <div class="form-check form-check-inline">
                        @if (old('transmisi', $car->transmisi) === 'Automated Manual Transmision (AMT)')
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-8">
                    <input type="number" class="form-control  @error('tahun') is-invalid @enderror" id="tahun" name="tahun" value="{{ old('tahun', $car->tahun) }}">
                    @error('tahun')
                        {{ $message }}
                    @enderror
                </div>
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-8">
                    <input type="number" class="form-control  @error('km') is-invalid @enderror" id="km" name="km" value="{{ old('km', $car->km) }}">
                    @error('km')
                        {{ $message }}
                    @enderror
                </div>
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-8">
                    <input type="number" class="form-control  @error('cc') is-invalid @enderror" id="cc" name="cc" value="{{ old('cc', $car->cc) }}">
                    @error('cc')
                        {{ $message }}
                    @enderror
                </div>
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-8">
                    <input type="number" class="form-control  @error('harga') is-invalid @enderror" id="harga" name="harga" value="{{ old('harga', $car->harga) }}">
                    @error('harga')
                        {{ $message }}
                    @enderror
                </div>
            ...
            <div class="mb-3">
                ...
                <input type="hidden" name="oldGambar" id="oldGambar" value="{{ $car->gambar }}">
                @if ($car->gambar)
                    <img src="{{ asset('storage/'.$car->gambar) }}" class="img-preview img-fluid my-3 col-sm-5 d-block">
                @else
